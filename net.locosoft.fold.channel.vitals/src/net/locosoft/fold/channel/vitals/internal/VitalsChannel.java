...
public class VitalsChannel extends AbstractChannel implements IVitalsChannel {
	...
	// ChannelHeaderFooterHtml htmlHeaderFooterSketch = new
	// ChannelHeaderFooterHtml(
	// this);
	// htmlHeaderFooterSketch.writeHeader(response.getWriter());
	//
	// VitalsHtml vitalsHtmlSketch = new VitalsHtml(this, "Vitals", -1); //
	// latest
	...
	//
	// TreeMap<Long, JsonValue> timeSeriesDataMap = new TreeMap<Long,
	// JsonValue>();
	//
	// long currentTimeMillis = System.currentTimeMillis();
	// int sampleCount = 40;
