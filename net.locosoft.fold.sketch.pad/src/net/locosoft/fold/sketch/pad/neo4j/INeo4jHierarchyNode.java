...
public interface INeo4jHierarchyNode extends INeo4jNodeSketch {

	long getSupId();

	long getSubId(String segment, boolean createIfAbsent);

	long[] getSubIds();

	String[] getSubSegments();

	class Impl extends INeo4jNodeSketch.Impl implements INeo4jHierarchyNode {

		public Class<? extends ISketch> getSketchInterface() {
			return INeo4jHierarchyNode.class;
		}
